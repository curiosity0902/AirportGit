...
namespace AirportGit.DB
{
    ...
    public partial class AirportEntities3 : DbContext
    {
        public AirportEntities3()
            : base("name=AirportEntities3")
        {
        }
        ...
        public virtual DbSet<Count_tickets> Count_tickets { get; set; }
